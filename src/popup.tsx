              ...
              >
                ...
                {isOpen && (
                  ...
                  >
                    <DetailRow
                      label="method"
                      value={event.details.detectionMethod}
                    />
                    {event.details.matchedSelector && (
                      <DetailRow
                        label="selector"
                        value={event.details.matchedSelector}
                      />
                    )}
                    {event.details.rawResult && (
                      <DetailRow
                        label="raw_result"
                        value={event.details.rawResult}
                      />
                    )}
                    {event.details.rawPlayingAs !== undefined && (
                      <DetailRow
                        label="playing_as"
                        value={String(event.details.rawPlayingAs)}
                      />
                    )}
                    {event.details.playerColor && (
                      <DetailRow
                        label="color"
                        value={event.details.playerColor}
                      />
                    )}
                    {event.details.endReason && (
                      <DetailRow
                        label="end_reason"
                        value={event.details.endReason}
                      />
                    )}
                    {event.details.puzzleId && (
                      <DetailRow
                        label="puzzle_id"
                        value={event.details.puzzleId}
                      />
                    )}
